...
- Map-layer acceptance should be deterministic before live-agent proof: a valid
  **Navigation Map Artifact**, **Metric Map Projection**, and backend-appropriate
  route validation such as **Sim Costmap Route Validation** should pass before
  Codex, Claude, or OpenClaw runs.
