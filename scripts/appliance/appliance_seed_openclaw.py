...
This is the appliance equivalent of ``scripts/openclaw/openclaw-bootstrap.sh``. It does
...
# Keep both direct execution and importlib-loaded tests independent of cwd.
sys.path.insert(0, str(_REPO_ROOT / "scripts" / "openclaw"))
...
def _openclaw_json(runtime: RuntimeConfig) -> dict[str, Any]:
    ...
    config: dict[str, Any] = {
            ...
            "list": [
                {
                    ...
                    "model": {"primary": provider.model},
                    # alsoAllow=["bundle-mcp"] mirrors scripts/openclaw/openclaw-bootstrap.sh
        ...
        # ``scripts/openclaw/openclaw_plugin_allowlist.py`` for the rationale and
