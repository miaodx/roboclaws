...
Usage:
    ...
    python scripts/openclaw/view-snapshots.py           # auto-pick newest run
    python scripts/openclaw/view-snapshots.py --run-dir output/runs/<ts>
    python scripts/openclaw/view-snapshots.py --port 8787
"""
