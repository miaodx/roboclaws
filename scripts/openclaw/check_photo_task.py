...
Runs against the artifact dir produced by ``examples/openclaw/openclaw_photo_task.py``.
...
Use:
    ...
    python scripts/openclaw/check_photo_task.py --run-dir output/openclaw-photo-task/<stamp>
    python scripts/openclaw/check_photo_task.py --run-dir <dir> --min-targets 2
"""
