...
``scripts/openclaw/openclaw-bootstrap.sh`` — see ``docs/human/openclaw/local.md`` for the
...
::
    ...
    python examples/openclaw/openclaw_demo.py \
...
def run_openclaw_demo(
    ...
    try:
        ...
        raise SystemExit(
            ...
            f"Hint: re-run `scripts/openclaw/openclaw-bootstrap.sh AGENTS={agent_count}` "
