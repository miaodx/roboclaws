...
Usage::
    ...
    python examples/games/single_agent_explore.py --scene FloorPlan201 --steps 50
    python examples/games/single_agent_explore.py --model gpt-4o-mini --output-dir out/explore
    python examples/games/single_agent_explore.py --model mock --steps 10 --output-dir /tmp/explore
"""
