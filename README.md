...
The console supports route metadata for local coding-agent drivers such as
Codex and Claude Code; it does not accept arbitrary browser-submitted shell
commands.
