...
2. [ ] Add `harness::molmo-planner-proof-bundle-runner`.
3. [ ] Add `verify::molmo-planner-proof-bundle-runner`.
4. [ ] Extend just recipe tests for the new harness and verify gate.
