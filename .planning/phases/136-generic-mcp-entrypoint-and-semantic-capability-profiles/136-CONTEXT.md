...
**Source:** PRD Express Path (`docs/plans/generic-mcp-entrypoint-semantic-capabilities.md`)
...
### Source Plan
- `docs/plans/generic-mcp-entrypoint-semantic-capabilities.md` — reviewed PRD,
