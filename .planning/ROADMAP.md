...
still remain `api_semantic`. The next MolmoSpaces slice should replace actual
cleanup-loop primitives behind the shared semantic driver instead of adding
another evidence-only report panel.
