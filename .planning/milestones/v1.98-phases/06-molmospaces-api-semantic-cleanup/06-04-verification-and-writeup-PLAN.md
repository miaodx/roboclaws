...
files_modified:
  ...
  - .planning/milestones/v1.98-phases/06-molmospaces-api-semantic-cleanup/06-*-SUMMARY.md
...
<task type="auto">
  ...
  <action>
    ...
    `docs/retrospectives/plans/molmospaces-manipulation-spike.md` from handoff-ready to phase
    shipped/verified.
  </action>
</task>
