...
from roboclaws.molmo_cleanup.manipulation_provenance import api_semantic_manipulation_evidence
...
from roboclaws.molmo_cleanup.semantic_cleanup_loop import (
...
def _cleanup_action_manipulation_evidence(
    cleanup_primitive_evidence: dict[str, Any],
) -> dict[str, Any]:
...
def _blocked_manipulation_evidence(
    manipulation_results: list[dict[str, Any]],
) -> dict[str, Any]:
    return {
