...
SEMANTIC_MAP_BUILD_RULES = (
    ...
    "waypoint with navigate_to_waypoint then observe. Mark a waypoint complete only "
    "after that waypoint_id has an observe response. Use resolve_target_query for "
    "any target-search, stale label, or open-ended map question and leave not-found "
    "claims tied to the returned public search budget. For camera-grounded-labels, call "
