...
Current human-facing project status lives in [`STATUS.md`](STATUS.md).

Use these sources instead:

- Current status and next action: [`STATUS.md`](STATUS.md)
...
to GSD so `.planning/` owns the execution ledger.
