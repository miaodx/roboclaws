...
| 5 | 架构图按 4 视角各画一张 | **TODO**——README 顶部用视角 I，ARCHITECTURE.md 用视角 IV，按职责切目录见视角 II | 让不同读者各取所需 |
...
下次 checkpoint（2026 年 5 月底）应优先回答这些。本期已经从 deep research 解决的，标 `[已解决于 2026-04]` 并给出综合答案；新提出的问题用 `[新增于 2026-04]` 标记。
