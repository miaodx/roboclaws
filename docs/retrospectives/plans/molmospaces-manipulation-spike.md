...
- `.planning/milestones/v1.98-phases/09-molmospaces-fpv-room-plausibility/09-VERIFICATION.md`
  records the verification evidence.
...
```text
completed:
  gsd-ingest-docs docs/retrospectives/plans/molmospaces-manipulation-spike.md
