...
```yaml
docs:
  - path: docs/retrospectives/plans/molmospaces-ci-live-agent-reports.md
    type: PRD
```

Then run `gsd-ingest-docs --manifest <manifest> --mode merge`, inspect the
created roadmap phase, and run
`gsd-plan-phase <created-phase> --prd docs/retrospectives/plans/molmospaces-ci-live-agent-reports.md`.
