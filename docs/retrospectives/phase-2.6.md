...
| 02.6-07 (docs-update) | `human/openclaw/local.md` + `human/openclaw/gateway-internals.md` aligned to MCP-era; this retro | — |
...
- Spike findings:
  [`.planning/milestones/v1.98-phases/02.6-.../02.6-SPIKE-FINDINGS.md`](../../.planning/milestones/v1.98-phases/02.6-openclaw-mcp-tools-integration/02.6-SPIKE-FINDINGS.md)
- Operator recipe:
  [`docs/human/openclaw/local.md` § MCP tool surface (Phase 2.6)](../human/openclaw/local.md#mcp-tool-surface-phase-26)
- Gateway internals (config gotchas):
  [`docs/human/openclaw/gateway-internals.md` § MCP config in openclaw.json](../human/openclaw/gateway-internals.md#mcp-config-in-openclawjson)
