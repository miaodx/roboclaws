...
2026-06-21: Isaac semantic-pose checker trace JSONL reads now route through
...
committing the Isaac semantic-pose trace-source slice. Avoid reopening closed
