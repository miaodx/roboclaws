...
10. Candidate P deterministic prep is accepted as a raw-FPV repeated visual
    ...
    Keep AA for the remaining raw-FPV image-memory policy row rather than the
    cross-lane next slice.
11. Defer C/D/K/E/F/M/W/X unless the dependency evidence below appears.
