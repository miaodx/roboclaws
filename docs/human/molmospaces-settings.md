...
| Map bundle | `assets/maps/molmo-cleanup-default-7` | Selected prebuilt Nav2-shaped static map bundle. | Default for non-smoke Molmo cleanup profiles. |
...
facade defaults to `assets/maps/molmo-cleanup-default-7`, and `map_bundle=...`
