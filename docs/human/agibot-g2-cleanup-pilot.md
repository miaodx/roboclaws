...
- `cleanup_profile=real_robot_cleanup_v1` if reading a legacy-format artifact;
  new route metadata should describe task-neutral household capability profiles
